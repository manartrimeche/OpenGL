    ...
    private void construct() {
        for (int i = 0; i < stacks; i++) {
            ...
            for (int j = 0; j < slices; j++) {
                ...
                Vertex v1 = new Vertex((float)x0,(float) y0);
                Vertex v2 = new Vertex((float)x1,(float) y1);
                Vertex v3 = new Vertex((float)x0, (float)y1);
                Vertex v4 = new Vertex((float)x1,(float) y0);
